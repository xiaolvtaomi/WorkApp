...
public class DishManageAdapter extends RecyclerArrayAdapter<Pair<Integer, Object>> implements ViewHolder_02.OnDishClickListener {
    ...
    public DishManageAdapter(Context context) {
        super(context);
    }
    ...
    public void OnBindViewHolder(BaseViewHolder holder, int position) {
        switch (superData.get(position).first) {
            ...
            case TYPE_DISHGROUP:
                ...
                ((ViewHolder_02) holder).setDataManage((Pair<DishBean, DishBean>) superData.get(position).second,

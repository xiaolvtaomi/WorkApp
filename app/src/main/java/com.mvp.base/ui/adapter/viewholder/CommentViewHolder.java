...
public class CommentViewHolder extends BaseViewHolder<com.mvp.base.model.bean.VideoType> {
    ...
    public void setData(com.mvp.base.model.bean.VideoType data) {
        ...
        if (!TextUtils.isEmpty(data.userPic))
            com.mvp.base.component.ImageLoader.load(getContext(), data.userPic, avatar);
    }
}

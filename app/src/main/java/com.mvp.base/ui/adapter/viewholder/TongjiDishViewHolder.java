...
public class TongjiDishViewHolder extends BaseViewHolder<TongjiDishBean> {
  ...
  //  TextView tv_item_community_num_first;
    ...
    public TongjiDishViewHolder(ViewGroup parent) {
        super(parent, R.layout.item_tongji_dish);
    ...
    @Override
    public void setData(TongjiDishBean mDishTongjiBean) {
        //super.initData(bean);

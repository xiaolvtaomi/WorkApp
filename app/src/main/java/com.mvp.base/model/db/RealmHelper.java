...
public class RealmHelper {
     ...
     * @param bean
     */
    public void insertCell(Cell bean) {
        getRealm().beginTransaction();
        getRealm().copyToRealm(bean);
        getRealm().commitTransaction();
    }

    public void updateCell (Cell bean, String npath){
        getRealm().beginTransaction();
        bean.setNpath(npath);
        getRealm().commitTransaction();
    }
    ...
    public void deleteCell(String id) {
        Cell data = getRealm().where(Cell.class).equalTo("id", id).findFirst();
        getRealm().beginTransaction();
    ...
    public List<Cell> getCellList() {
        ...
        RealmResults<Cell> results = getRealm().where(Cell.class).findAllSorted("time", Sort.DESCENDING);
        return getRealm().copyFromRealm(results);
    }


    public Cell getCellByNpath(String path ){
        Cell data = getRealm().where(Cell.class).equalTo("npath", path).findFirst();
        return data ;

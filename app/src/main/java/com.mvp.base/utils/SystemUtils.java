...
import com.mvp.base.model.bean.AppInfo;
...
public class SystemUtils {
    ...
    public static final int PAYSTATUS_NOPAY = 2 ;

    public static int getPayStatus(Context context){
        int paystatus = 0 ;

        paystatus = PreUtils.getInt(context, "xingbie", PAYSTATUS_NOPAY);

        return paystatus ;
    }

    public static void setPayStatus(Context context){
        PreUtils.putInt(context, "xingbie", PAYSTATUS_PAID);
    }
}
